  ...
  return (
    <Element name="about" className={styles.main}>
      ...
      <p className={`${styles.text} ${styles[position]}`}>
        ...
        My educational background is a bachelors in Computer Science,
        and multiple udemy courses to further improve my skills, in react, redux, nodeJS.
        I have created projects using React and front end
        frameworks such as bootstrap and material-ui, with a nodeJS backend,
        using ExpressJS and databases such as mongoDB.
      </p>
      <footer>
